...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style.css?v=4">
...
<div class="container">
	...
	<header>
		...
		<a href="<?php echo home_url(); ?>" class="logo"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt=""></a>
