	...
	<?php foreach ($users as $user) : ?>
		...
		<?php if ($user->display_name != 'admin') : ?>
			...
			<div class="profile">
				...
				<div class="image"><?php echo get_avatar( $user->user_email, '400' ); ?></div>
				<div class="text">
					...
					<p class="contact-info">
						...
						<?php if ( get_the_author_meta( 'phone', $user->ID )) : ?>
							<span class="glyphicon glyphicon-phone"></span><a href="tel:<?php echo esc_attr( get_the_author_meta( 'phone', $user->ID ) ); ?>"><?php echo esc_attr( get_the_author_meta( 'phone', $user->ID ) ); ?><?php the_author_meta( 'phone' ); ?></a><br>
						<?php endif; ?>
